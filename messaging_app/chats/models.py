...
class Conversation(models.Model):
    """Model to track conversations with multiple participants."""
...
class Message(models.Model):
    ...
    message_body = models.TextField(null=False, blank=False)  # Renamed from content to message_body
    sent_at = models.DateTimeField(auto_now_add=True)

    class Meta:
        indexes = [
            models.Index(fields=['message_id'], name='msg_id_idx'),
        ]
